        ...
        builder: (_) {
          return Scaffold(
            ...
            appBar: AppBar(
              ...
              actions: [IconButton(onPressed: () {}, icon: const Icon(Icons.keyboard_arrow_down_outlined, size: 32))],
              bottom: TabBar(
                isScrollable: true,
                onTap: (value) {
            ...
            body: TabBarView(
              ...
              children: [
                ...
                Center(
                  child: Text(
                    controller.titles[controller.tabController.index],
                          ...
                          child: TextFormField(
                            ...
                            decoration: InputDecoration(
                              ...
                              suffixIcon: Row(
                                ...
                                children: [
                                  Text("${controller.searchTEC.text.length}/50", style: const TextStyle(color: Colors.grey)),
